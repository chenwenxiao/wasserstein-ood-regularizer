...
'models/likelihood/vae.py --use_transductive=False --mixed_ratio=0.1 --count_experiment=True'
'models/likelihood/vae.py --count_experiment=True'
'models/likelihood/vae.py --mixed_ratio=0.1 --count_experiment=True'
...
'models/likelihood/pixelcnn.py --use_transductive=False --mixed_ratio=0.1 --count_experiment=True'
'models/likelihood/pixelcnn.py --count_experiment=True'
'models/likelihood/pixelcnn.py --mixed_ratio=0.1 --count_experiment=True'
...
'models/wgan/wasserstein.py --use_transductive=False --mixed_ratio=0.1 --count_experiment=True'
'models/wgan/wasserstein.py --count_experiment=True'
'models/wgan/wasserstein.py --mixed_ratio=0.1 --count_experiment=True'
...
'models/likelihood/glow.py --use_transductive=False --mixed_ratio=0.1 --count_experiment=True'
'models/likelihood/glow.py --count_experiment=True'
'models/likelihood/glow.py --mixed_ratio=0.1 --count_experiment=True'
